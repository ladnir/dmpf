...
With $P$ polynomials per party and $t$ selected positions per polynomial,
each cross-party product has $t^2$ indexed terms, possibly zero.
For regular noise, one position lies in each block of length
$L=N_{\mathsf R}/t$.
