...
the switch to exact-uniform permutations, and the use of independent
evaluator seeds for each product list.
...
the current parameter recipe. These results characterize the measured
revision, not the complete current recipe.
...
\node[overlay,font=\scriptsize,anchor=south west,yshift=16pt] at (axis cs: 0,1) {Dedup+};
